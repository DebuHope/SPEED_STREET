...
{
	{L"data/bgm/BGM02.wav", -1},
	{L"data/se/run1.wav", -1},	
	{L"data/se/dash01.wav", 0},	
	{L"data/se/jump.wav", 0},	
	{L"data/se/slide01.wav", 0},
	{L"data/se/hit02.wav", 0},	
	{L"data/se/candy01.wav", 0},
	{L"data/se/fall01.wav", 0},
	{L"data/se/checkpoint01.wav", 0},
};
...
{	// MAX:100	MIN:-XAUDIO2_MAX_VOLUME_LEVEL
	if (g_apSourceVoice[label])
	{
		g_apSourceVoice[label]->SetVolume(fVol);
	}
}
